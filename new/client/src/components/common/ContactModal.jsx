...
// Preserved your exact input component
          ...
          >
            ...
            <div className="hidden md:flex md:w-2/5 relative flex-col justify-between p-8 text-white">
              <div className="absolute inset-0 z-0">
                <img src={assets.connectBanner} alt="Travel" className="w-full h-full object-cover"/>
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/80 text-sm">Let us handle the details while you create the memories.</p>
              </div>
            ...
            {/* RIGHT SIDE (Preserved with scrollbar-hide) */}
            <div className="flex-1 flex flex-col relative bg-white">
              ...
              <button onClick={onClose} className="absolute top-4 right-4 p-2 bg-gray-50 hover:bg-red-50 text-gray-400 hover:text-red-500 rounded-full transition-colors z-20 cursor-pointer">
                <X size={20} />
              </button>

              <div className="p-6 md:p-10 overflow-y-auto scrollbar-hide h-full">
                <div className="hidden md:block mb-8">
                    <h3 className="text-3xl font-bold text-[var(--wander-teal)] font-[var(--font-cormorant)]">Let's Chat!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="relative group">
                        ...
                        <textarea 
                            id="msg" name="message" value={formData.message} onChange={handleChange} rows="3" 
