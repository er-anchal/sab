            ...
            <SwiperSlide key={pkg.id}>
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col h-full border border-gray-100 group hover:shadow-2xl transition-shadow duration-300">
                ...
                <div className="p-6 flex flex-col flex-grow text-center">
                  ...
                  <button className="mt-auto w-full py-3 rounded-xl text-white font-bold bg-gradient-to-r from-[#e75480] to-[#ffb6c1] hover:from-[#ffb6c1] hover:to-[#e75480] transition-all shadow-md">
                    View Details
                  </button>
                </div>
              </div>
